...
"""
    ...
    Including Method that print instance of class Square
"""
...
class Square:
    ...
    def __repr__(self):
        """
        Function that have same behavior of my_print
        Will be invoked when an instance of class Square is printed
        """
        str = ""
        if self.__size == 0:
            return str
